...
echo "Unpacking data..."
tar -xf scFoundation_PASCODE_c90x.tar
rm scFoundation_PASCODE_c90x.tar

####### TRAINING SCRIPT STARTS #########

PYTHON_CMD="python3 train_cv.py"
DATA_PATH="extracted_cell_embeddings_PASCODE_c90x"
...
tar -cvf results_scFoundation_c90x.tar results_scFoundation
