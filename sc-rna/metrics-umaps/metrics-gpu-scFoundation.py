...
# === GPU memory setup ===
rmm.reinitialize(pool_allocator=True, initial_pool_size="74GiB", maximum_pool_size="78GiB")
...
# === Output CSV setup ===
metrics_output = os.path.join(output_dir, "scFoundation_metrics.csv")
...
# === Filter metadata to only include selected donors
meta = meta[meta["SubID"].isin(donors)].copy()
